KISSY.use("node, ua, ajax", function(a) {
	a.ready(function(a) {
		...
		function d() {
			switch(m) {
				case 1:
					h.f_f && n && !h.s_f ? g.cut(2, g[2]) : n && h.s_f && g.cut(2);
					break;
				case 2:
					h.s_f && n && !h.t_f ? (e(".cover").show(), f.shirt_s.show().animate({
						bottom: 255 - k,
						left: 260,
						width: "auto"
					}, 1, "easeNone", function() {
					...
					break;
				case 3:
					h.t_f && n && !h.fo_f ? (f.shirt_t_f.hide(), f.shirt_t.show().animate({
						bottom: 200 - b(1),
						left: 260
					}, 1, "easeNone", function() {
					...
					break;
				case 4:
					h.fo_f && n && !h.fi_f ? g.cut(5, g[5]) : n ? n && h.fi_f && g.cut(5) : (h.fo_f = !0, g.cut(3));
					break;
				case 5:
					h.fi_f && n && !h.si_f ? (f.item_fi.css("overflow", "visible"), f.shirt_fi_s.hide(), f.shirt_fi_t.show().animate({
						bottom: 506 - b(1),
						width: 65,
						left: "40%"
					}, 1, "easeNone", function() {
					...
					break;
				case 6:
					h.si_f && n && !h.se_f ? g.cut(7, g[7]) : n ? n && h.se_f && g.cut(7) : (h.si_f = !0, g.cut(5));
					break;
				case 7:
					h.se_f && n ? g.cut(8) : n || (h.se_f = !0, g.cut(6));
					break;
				case 8:
					n || g.cut(7)
			}
		...
		var e = a.all,
			...
			i = !1,
			j = !1,
			k = parseInt(e(window).height(), 10),
			l = parseInt(e(window).width(), 10),
			m = Math.ceil(e(window).scrollTop() / k) + 1,
			n = !0;
		f = {
			fly: e(".fly"),
			goods: e(".goods"),
			word_s_f: e(".word-02-1"),
			word_s_s: e(".word-02-2"),
			search_s: e(".search"),
			search_w: e(".search-words"),
			search_s_s: e(".search-02-1"),
			goods_s: e(".goods-02"),
			shirt_s: e(".shirt-02"),
			box: e("#box"),
			img_t_a: e(".img-03-a"),
			btn_t_a: e(".btn-03-a"),
			shirt_t: e(".shirt-03"),
			shirt_t_f: e(".shirt-03-1"),
			shirt_f: e(".shirt-04"),
			item_fo: e(".item-4"),
			cart_f: e(".cart"),
			word_f_f: e(".word-04-1"),
			word_f_s: e(".word-04-2"),
			note_f: e(".note"),
			word_f: e(".word-04"),
			cloud_f: e(".cloud"),
			item_fi: e(".item-5"),
			hand_fi: e(".hand-05"),
			mouse_fi: e(".mouse-05-a"),
			shirt_fi: e(".shirt-05"),
			shirt_fi_s: e(".shirt-05-1"),
			shirt_fi_t: e(".shirt-05-2"),
			order_fi: e(".order-05"),
			box_si: e(".box-06"),
			words_si_f: e(".words-06-1"),
			words_si_s: e(".words-06-2"),
			cloud_si: e(".cloud-06"),
			cloud_si_f: e(".cloud-06-1"),
			cloud_si_s: e(".cloud-06-2"),
			item_si: e(".item-6"),
			bus_si: e(".bus-05"),
			pop_si_f: e(".pop-06-1"),
			pop_si_s: e(".pop-06-2"),
